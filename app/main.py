...
def create_incident(incident: IncidentCreate):
    ...
    cur.execute(
        "INSERT INTO incidents (service_name, title, description, severity) VALUES (%s, %s, %s, %s) RETURNING id",
        (
...
def list_incidents():
    ...
    cur.execute(
        "SELECT id, service_name, title, severity, status, created_at, resolved_at FROM incidents ORDER BY created_at DESC"
    )
